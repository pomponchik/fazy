...
['casefold', 'expandtabs', 'format_map', 'isidentifier', 'istitle', 'ljust', 'lstrip', 'maketrans', 'partition', 'removeprefix', 'removesuffix', 'rfind', 'rindex', 'rjust', 'rpartition', 'rsplit', 'rstrip', 'splitlines', 'swapcase']
